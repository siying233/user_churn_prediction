...
> 如果你在 GitHub 上查看，文件可能因渲染限制无法完全显示图表和交互内容。建议选择[html版本](https://nbviewer.org/github/siying233/user_churn_prediction/blob/main/x_user_churn_prediction.ipynb) 进行查看
